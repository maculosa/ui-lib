<template>
  <div
    class="my-[40px] rounded-[8px] overflow-hidden bg-transparent backdrop-blur-1 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] b-zinc-300/40 dark:b-gray/40 b-[1px] b-solid"
  >
