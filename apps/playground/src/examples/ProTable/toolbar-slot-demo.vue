...
const columns = ref([
  { type: 'index' },
  {
    ...
    sorter: 'default',
    filter: true,
    filterOptions: [{ label: 'London', value: 'London' }],
  ...
  },
  {
    ...
    render(row: any) {
      return (
        <NSpace wrap={false}>
          <ModalForm title="编辑" columns={columns.value} model={row}>
            <NButton size="tiny" type="primary" text>
              编辑
            </NButton>
          </ModalForm>
...
function handleImport() {
  message.success('This is an Import Function')
}
</script>
